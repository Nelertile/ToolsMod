package io.github.nottoxicdev.block;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block, ItemGroup group) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(ToolsMod.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block, ItemGroup group) {
        return Registry.register(Registry.ITEM, new Identifier(ToolsMod.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings().group(group)));
    }

    public static void registerModBlocks() {
        ToolsMod.LOGGER.info("Registering ModBlocks for " + ToolsMod.MOD_ID);
    }
}
